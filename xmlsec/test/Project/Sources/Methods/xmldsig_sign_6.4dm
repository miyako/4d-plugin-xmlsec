...
$params.xades.qualifyingProperties.signedProperties.signedSignatureProperties.signaturePolicyIdentifer.signaturePolicyId[0].sigPolicyQualifiers:=[{SPURI: "https://sede.administracion.gob.es/politica_de_firma_anexo_1.pdf"}]
